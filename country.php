    <div class="form-group">
        ...
        <select class="form-control"  id="country">
            ...
            <option value="TF">الأراضي الفرنسية الجنوبية والقطبية الجنوبية</option>
            <option value="AR">الأرجنتين</option>
            <option value="JO">الأردن</option>
            <option value="ME">الأسود</option>
            ...
            <option value="XK">جمهورية كوسوفو</option>
            <option value="MK">جمهورية مقدونيا</option>
            ...
            <option value="SX">سان مارتن</option>
            ...
            <option value="CC">كوكوس (كيلينغ جزر</option>
            ...
            <option value="LU">لكسمبرغ</option>
            ...
            <option value="FM">ميكرونيزيا (ولايات-الموحدة</option>
